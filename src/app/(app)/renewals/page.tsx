...
export default async function RenewalsPage({
  ...
  // Cycles due in ≤7 days or overdue
    ...
    return (
      <div className="flex flex-col h-full">
        ...
        <div className="flex-1 p-6">
          <div className="bg-white rounded-2xl border border-[#abadaf]/20 p-12 text-center">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-12 w-12 mx-auto mb-3 text-[#abadaf]" viewBox="0 0 24 24" fill="currentColor">
              <path d="M12 4V1L8 5l4 4V6c3.31 0 6 2.69 6 6 0 1.01-.25 1.97-.7 2.8l1.46 1.46C19.54 15.03 20 13.57 20 12c0-4.42-3.58-8-8-8zm0 14c-3.31 0-6-2.69-6-6 0-1.01.25-1.97.7-2.8L5.24 7.74C4.46 8.97 4 10.43 4 12c0 4.42 3.58 8 8 8v3l4-4-4-4v3z"/>
            </svg>
            <p className="text-[#595c5e] font-medium">Sin renovaciones pendientes</p>
            <p className="text-sm text-[#747779] mt-1">No hay ciclos que venzan en los próximos 7 días.</p>
          </div>
        </div>
      </div>
    )
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex-1 p-6 space-y-5">
        ...
        <div className="flex gap-3 flex-wrap">
          {overdueCount > 0 && (
            <span className="flex items-center gap-1.5 text-xs font-medium text-[#b31b25] bg-[#b31b25]/10 border border-[#b31b25]/20 px-3 py-1.5 rounded-full">
              <span className="w-1.5 h-1.5 rounded-full bg-[#b31b25]" />
        ...
        <div className="space-y-3">
          {items.length === 0 ? (
            <div className="bg-white rounded-2xl border border-[#abadaf]/20 p-8 text-center text-sm text-[#595c5e]">
